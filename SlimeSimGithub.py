...
for file_name in os.listdir(png_dir):
    ...
    os.remove(file_path)
iterat=1000 # Number of images to be generated 
...
widthorig =704
heightorig =704  
scale_percent = 100 # percent of original size for higher simulation resolusion
...
imageio.mimsave('Anim.mp4',images, fps=20)    
